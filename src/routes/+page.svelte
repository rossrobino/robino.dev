	...
	>
				...
				<section class="mb-24">
					<div class="flex flex-wrap gap-2 py-4">
						{#each features as feature}
							<div>
								<button
									class="h-full rounded-sm px-4 py-2 capitalize hover:bg-teal-500 hover:bg-opacity-30 active:bg-opacity-20 disabled:hover:bg-transparent"
		...
		<footer class="mb-12">
			<ul>
				...
				<li>
					<ShareButton
						class="mt-2 rounded-sm bg-teal-500 bg-opacity-20 px-4 py-2 hover:bg-opacity-30 active:bg-opacity-20"
